...
def main():
    # Load the YOLO26 ONNX model 
    print("Loading YOLO26 ONNX model...")
    ...
    print("Starting object detection (ONNX). Press 'q' to quit.")
    ...
    while True:
        ...
        # Display the output
        cv2.imshow("Raspberry Pi Object Detection - ONNX", annotated_frame)
